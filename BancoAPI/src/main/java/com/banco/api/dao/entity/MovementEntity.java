...
public class MovementEntity {
    ...
    private com.banco.api.dao.entity.ServiceEntity service;
    ...
    public MovementType getMovementType() {
        ...
        if (movementType == 2) {
            mt = MovementType.COMMISSION_OR_MAINTENANCE;
        }
        if (movementType == 3) {
            mt = MovementType.SERVICES_PAYMENT;
        }
        return mt;
    }
    ...
    public void setMovementType(MovementType mt) {
        ...
        if (MovementType.COMMISSION_OR_MAINTENANCE == mt) {
            this.movementType = 2;
        }
        if (MovementType.SERVICES_PAYMENT == mt) {
            this.movementType = 3;
        }
    }
